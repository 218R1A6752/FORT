    ...
    <>
      ...
      {/* <Modal isOpen={isPreviewOpen} onClose={() => setIsPreviewOpen(false)}>
        ...
        <div className="p-6 flex justify-between items-center border-t border-gray-100">
          <div>
            <h3 className="text-xl font-bold bg-gradient-to-br from-secondary-900 to-secondary-700 bg-clip-text text-transparent">
              {template.name}
            </h3>
            <p className="text-secondary-600 text-sm">{template.category}</p>
          </div>
          <a
            href={template.downloadUrl}
